export class LGUIComponent {
    ...
    _update() {
        ...
        this.#children = [];
        if (this.#root == this) container.innerHTML = this.onrender();
        else container.innerHTML = container.innerHTML.replace(RegExp(`<!--${this.#path}-->[\\s\\S]*<!--\\/${this.#path}-->`, "gm"), this.toString());
    ...
    _ref (name) {
        ...
        if (typeof this[name] == "undefined" && typeof document != "undefined") Object.defineProperty(this, name, { get: () => document.getElementById(id) });
        return id;
    }
    _getContainer() {
        if (typeof document == "undefined") return null;
        if (this.#root == this) return document.body;
